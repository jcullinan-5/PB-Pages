...
declare function isOpen24h(params: StatusParams): boolean;
declare function isIndefinitelyClosed(params: StatusParams): boolean;
declare function defaultCurrentTemplate(params: StatusParams): React__default.ReactNode;
declare function defaultSeparatorTemplate(params: StatusParams): React__default.ReactNode;
declare function defaultFutureTemplate(params: StatusParams): React__default.ReactNode;
declare function defaultTimeTemplate(params: StatusParams): React__default.ReactNode;
declare function defaultDayOfWeekTemplate(params: StatusParams): React__default.ReactNode;
