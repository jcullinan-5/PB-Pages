...
const defaultTransformer = (breadcrumbsData) => {
  return breadcrumbsData.dm_directoryParents.map((breadcrumbData) => [breadcrumbData.name, breadcrumbData.slug]);
};
...
class HoursInterval {
  ...
  is24h() {
    const startIs00 = this.start.getMinutes() === 0 && this.start.getHours() === 0;
    const endIs00 = this.end.getMinutes() === 0 && this.end.getHours() === 0;
    const daysAreConsecutive = this.end.getDate() - this.start.getDate() === 1 || this.end.getDate() === 1;
...
const HoursTable = (props) => {
  ...
  return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, isClient && /* @__PURE__ */ React__default["default"].createElement("div", {
    ...
    }, intervalStrings.map((intervalString, idx) => /* @__PURE__ */ React__default["default"].createElement("span", {
...
exports.defaultCurrentTemplate = defaultCurrentTemplate;
exports.defaultDayOfWeekTemplate = defaultDayOfWeekTemplate;
exports.defaultFutureTemplate = defaultFutureTemplate;
exports.defaultSeparatorTemplate = defaultSeparatorTemplate;
exports.defaultStatusTemplate = defaultStatusTemplate;
exports.defaultTimeTemplate = defaultTimeTemplate;
exports.getDirections = getDirections;
exports.intervalsListsAreEqual = intervalsListsAreEqual;
exports.isIndefinitelyClosed = isIndefinitelyClosed;
exports.isOpen24h = isOpen24h;
