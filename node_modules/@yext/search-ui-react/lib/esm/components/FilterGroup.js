...
import { CheckboxOption, CollapsibleLabel, builtInCollapsibleLabelCssClasses, CollapsibleSection, SearchInput, FilterGroupProvider, useFilterGroupContext } from './Filters';
/**
...
export function FilterGroup({ fieldId, filterOptions, title, collapsible = true, defaultExpanded = true, searchable, customCssClasses = {}, showMoreLimit = filterOptions.length, children }) {
    ...
    const collapsibleLabelCssClasses = useMemo(() => {
        return {
    ...
    function renderTitle() {
        return collapsible
            ? _jsx(CollapsibleLabel, { label: title, customCssClasses: collapsibleLabelCssClasses }, void 0)
            : (title &&
                _jsx("div", Object.assign({ className: twMerge('mb-4', builtInCollapsibleLabelCssClasses.label, collapsibleLabelCssClasses.label) }, { children: title }), void 0));
    }
