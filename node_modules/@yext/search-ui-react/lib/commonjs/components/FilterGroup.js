...
function FilterGroup({ fieldId, filterOptions, title, collapsible = true, defaultExpanded = true, searchable, customCssClasses = {}, showMoreLimit = filterOptions.length, children }) {
    ...
    const collapsibleLabelCssClasses = (0, react_2.useMemo)(() => {
        return {
    ...
    function renderTitle() {
        return collapsible
            ? (0, jsx_runtime_1.jsx)(Filters_1.CollapsibleLabel, { label: title, customCssClasses: collapsibleLabelCssClasses }, void 0)
            : (title &&
                (0, jsx_runtime_1.jsx)("div", Object.assign({ className: (0, useComposedCssClasses_1.twMerge)('mb-4', Filters_1.builtInCollapsibleLabelCssClasses.label, collapsibleLabelCssClasses.label) }, { children: title }), void 0));
    }
