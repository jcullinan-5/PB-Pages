...
const autoYextInitWithYextrc = async (scope) => {
  ...
  if (accountId === void 0 || universe === void 0) {
    ...
    await runCommand("yext", ["init", accountId, "-u", universe]).then((output) => console.log(output)).catch((error) => {
      console.log(error.message);
      process.exit(1);
    });
  }
};
const autoYextInitUpdateYextrc = async (scope) => {
  try {
    console.log(
      `
...
(e.g. \`yext.com/s/` + chalk.bold(`<ACCOUNT_ID>`) + `/home\`)
  `
  );
